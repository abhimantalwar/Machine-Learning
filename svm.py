...
def plotData(X, Y, c):
    ...
    inputImg = X[c,:]
    imshow((inputImg.reshape(40,40)).T, cmap = 'Greys')
...
for x in imageName:
    ...
    fullname = os.path.join('/home/abhiman/deep_learning/abhi/testImages/',x)
    ...
    im1 = ndimage.grey_dilation(im1, size = (50,50))
